...
if("FALSE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-map-server-1.12.7)
  set(map_server_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-map-server-1.12.7/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
