...
if("FALSE" STREQUAL "TRUE")
  set(nav2d_tutorials_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-nav2d-tutorials-0.1.4)
  set(nav2d_tutorials_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-nav2d-tutorials-0.1.4/obj-x86_64-linux-gnu/devel)
  ...
  set(nav2d_tutorials_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav2d_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Sebastian Kasperski <sebastian.kasperski@dfki.de>' to fix it.")
    endif()
