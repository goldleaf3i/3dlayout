...
def start_main(parametri_obj, path_obj):	
	...
	#nel primo if c'e' la versione di matteo, nel secondo la mia
	if nuovo_clustering ==1:
		...
		(indici, walls, cluster_angolari) = lay.cluster_ang_versione_due(parametri_obj.h, parametri_obj.minOffset, walls, diagonali= parametri_obj.diagonali)
		print "la lunghezza della lista cluster angolari e': ", len(cluster_angolari)
