...
# 		
	...
	a = sp.estrai_extended_da_spazio(spazi_parziali[0], plan_o.extended_segments, cellette_out)
	dsg.disegna_extended_segments(a, walls,filepath = path_obj.filepath, format='png', savename = '7a_extended')		
	b= sp.estrai_solo_extended_visti(spazi_parziali[0], plan_o.extended_segments, cellette_out)
	dsg.disegna_extended_segments(b, walls,filepath = path_obj.filepath, format='png', savename = '7b_extended')		
	print len(a)
	print len(b)
	exit()
