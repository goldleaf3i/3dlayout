...
# 			dsg.disegna_stanze(poligoni,colori , xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = '15_poligoni_esterni_stanza'+str(index), format='png')	
	...
	if par.mappa_completa:
		...
		percentuali_completamento_mappa = acpar.calcola_percentuali_completamento_mappa(stanze, lista_gt_proporzionata)
		for index, percentuali in enumerate(percentuali_completamento_mappa):
			print "la percentuele e' ", index, percentuali
