...
class Path_obj():
	def __init__(self):
		...
		self.metricMap = './data/INPUT/PARZIALI/battle_creekhs_1_updated118.png'
		...
		self.nome_gt = './data/INPUT/XMLs/PARZIALI/battle_creekhs_1_updated118.xml'
