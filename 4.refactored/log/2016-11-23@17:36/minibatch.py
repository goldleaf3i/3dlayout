...
# 		
	...
	#costruisco il grafo 
	(stanze_collegate, doorsVertices, distanceMap, points, b3, b4) = gtop.get_grafo(path_obj.metricMap, stanze, estremi, colori, parametri_obj)
	...
	#disegno le porte
	dsg.disegna_medial_axis(points, b3, filepath = path_obj.filepath, format='png', savename='11_b_porte')
