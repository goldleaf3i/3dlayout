...
# 		
	...
	if par.azione_complessa == True:
		...
		for index,s in enumerate(spazi_parziali):
			...
			level= 2 #questa e la profondita con la quale faccio la mia ricerca, oltre al terzo livello non vado a ricercare le celle.
			...
			#per ogni permutazione di elementi devo controllare il costo che avrebbe il layout con l'aggiunta di tutte quelle celle.
