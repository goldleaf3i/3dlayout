		...
		for index,s in enumerate(spazi_parziali):
			...
			for indice,permutazione in enumerate(permutazioni):
				...
				if type(s.spazio)== Polygon:		
					dsg.disegna_spazi(plan_o.spazi, dsg.get_colors(plan_o.spazi), xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = 'permutazioni/14_permutazioni_'+str(indice)+'_a', format='png')
				...
				if type(s.spazio)== Polygon:
					...
					dsg.disegna_spazi(plan_o.spazi, dsg.get_colors(plan_o.spazi), xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = 'permutazioni/14_permutazioni_'+str(indice)+'_b', format='png')
				else:
