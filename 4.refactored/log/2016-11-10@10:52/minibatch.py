...
# 		
	...
	for index,s in enumerate(spazi_parziali):
		...
		dsg.disegna_extended_segments(a, walls,filepath = path_obj.filepath, format='png', savename = '7a_extended'+index)		
		b= sp.estrai_solo_extended_visti(s, plan_o.extended_segments, cellette_out)
		dsg.disegna_extended_segments(b, walls,filepath = path_obj.filepath, format='png', savename = '7b_extended'+index)		
		print len(a)
		print len(b)
	exit()
