...
# 		
	...
	a = sp.estrai_extended_da_spazio(spazi_parziali[1], plan_o.extended_segments, cellette_out)
	b= sp.estrai_solo_extended_visti(spazi_parziali[1], plan_o.extended_segments, cellette_out)
	print len(a)
	print len(b)
	exit()
