...
# 		dsg.disegna_segmenti(outliers, savename = "outliers")
	...
	uniciStanzeOversegmentate = True
	if uniciStanzeOversegmentate ==True:
		#unione stanze
		...
		print "colori", len(colori)
		print "spazi", len(plan_o.spazi)
		dsg.disegna_spazi(plan_o.spazi, colori, xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = '13b_spazi_nuovi')	
