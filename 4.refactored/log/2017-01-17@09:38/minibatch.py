	...
	if par.mappa_completa:
		...
		for perc_mappa_bwd, perc_mappa_fwd in zip(lista_percentuali_completamento_mappa_bwd,lista_percentuali_completamento_mappa_fwd):
			...
			if valore > max_val_2 and valore < max_val_1:
				...
				indice = i
			i+=1
		lista_tre_accuracy_migliori.append(indce)
		...
		if par.DISEGNA:
			...
			for index, gt_prorp in enumerate(lista_gt_proporzionata):
				if index == lista_tre_accuracy_migliori[0] or index == lista_tre_accuracy_migliori[1] or index == lista_tre_accuracy_migliori[2]:
			...
			for perc_mappa_bwd, perc_mappa_fwd, perc_GT_bwd, perc_GT_fwd in zip(lista_percentuali_completamento_mappa_bwd, lista_percentuali_completamento_mappa_fwd, lista_percentuali_completamento_GT_bwd, lista_percentuali_completamento_GT_fwd):
				if i == lista_tre_accuracy_migliori[0] or i == lista_tre_accuracy_migliori[1] or i == lista_tre_accuracy_migliori[2]:
