...
# 		
	...
	if par.azione_complessa == True:
		...
		for s in spazi_parziali:
			...
			print "le celle confinanti che vorrei aggiungere con l'azione geometrica 1 sono: ", len(celle_confinanti)
			...
			poligoni= []
			colori=[]
			for ele in celle_confinanti:
				poligoni.append(ele.cella)
				colori.append('#800000')
			print "il nuemro di poligoni all'esterno sono: ", len(poligoni)
			dsg.disegna_stanze(poligoni,colori , xmin+20, ymin+20, xmax+20, ymax+20,filepath = path_obj.filepath, savename = '15_contorno_stanza', format='png')	
