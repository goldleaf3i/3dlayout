...
# 		dsg.disegna_segmenti(outliers, savename = "outliers")
	...
	#------------------------------GRAFO TOPOLOGICO---------------------------------------
	#unisco le stanze che sono state divise erroneamente
	uniciStanzeOversegmentate = True
	if uniciStanzeOversegmentate ==True:
		#unione stanze
		#1) creo un grafo che connette tutte le stanze vincine.
		#2) elimino la connessione se esiste una porta
		#3) ogni nuovo grafo e' una nuova stanza composta da varie stanze che vanno unite
