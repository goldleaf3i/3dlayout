...
class Path_obj():
	def __init__(self):
		...
		self.metricMap = './data/INPUT/PARZIALI/scuola_sconosciuta_3_updated111.png'
...
class Parameter_obj():
	def __init__(self):
		...
		#flip_dataset = False #questo lo metti a true se la mappa che stai guardando e' di SURVEY o e' PARZIALE
