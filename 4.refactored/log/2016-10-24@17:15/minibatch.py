...
# 		
	...
	dsg.disegna_spazi(plan_o.spazi, dsg.get_colors(plan_o.spazi), xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = '13c_celle_aggiunte_azione_geom_1')	
	...
	for s in spazi_parziali:
		...
		#delle celle confinanti appena estratte devo prendere solamente quelle che hanno un supporto da una extended line
		#celle_confinanti = pgeom.estrai_celle_supportate(plan_o, celle_confinanti, s)
	...
	dsg.disegna_spazi(plan_o.spazi, dsg.get_colors(plan_o.spazi), xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = '13d_celle_aggiunte_azione_geom_2')	
