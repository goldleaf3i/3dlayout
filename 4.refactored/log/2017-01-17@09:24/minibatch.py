	...
	if par.mappa_completa:
		...
		for perc_mappa_bwd, perc_mappa_fwd in zip(lista_percentuali_completamento_mappa_bwd,lista_percentuali_completamento_mappa_fwd):
			...
			if valore >max_val_1:
				...
				indice = i
			i+=1
		lista_tre_accuracy_migliori.append(lista_gt_proporzionata[indice])
		...
		#copio la lista con le tre migliori al posto di quella completa
		lista_gt_proporzionata = lista_tre_accuracy_migliori #questa riga, se voglio tutte le configurazioni per l'accuracy, la devo cancellare
