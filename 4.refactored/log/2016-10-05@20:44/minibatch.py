...
#continuare da qui. ottengo le celle parziali. Ne ho una sbagliata perche' la cella che viene classificata male ha un bordo che e' attaccato ad una cella out.
	exit()
