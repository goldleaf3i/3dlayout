...
# 		print len(set(cluster))
	...
	#--------creo l'oggetto oggetti plan che contiene tutte le stanze
	
	#controllo cosa viene disegnato con spazi
	dsg.disegna_spazi(spazi, colori, xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = 'spazi')	
