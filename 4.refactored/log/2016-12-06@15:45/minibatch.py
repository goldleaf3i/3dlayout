...
# 			dsg.disegna_stanze(poligoni,colori , xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = '15_poligoni_esterni_stanza'+str(index), format='png')	
	...
	if par.mappa_completa:
		...
		#provo a disegnare un immagine che con solo i bordi
		col = []
		for s in plan_o.spazi:
			col.append("#ffffff")
		dsg.disegna_spazi(plan_o.spazi,col, xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = 'puzzle.png', format='png')
