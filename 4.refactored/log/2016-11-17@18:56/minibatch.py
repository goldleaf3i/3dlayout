...
# 		
	...
	if par.azione_complessa == True:
		...
		for index,s in enumerate(spazi_parziali):
			...
			#delle celle canidate non devo unire quelle che farebbero sparire una parete.
			#elementi = pgeom.elimina_celle_con_parete_vista(elementi, s)#TODO: valutare se in questo caso funziona
			'''
