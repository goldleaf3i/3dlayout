...
class Path_obj():
	def __init__(self):
		...
		self.metricMap = './data/INPUT/IMGs/SCHOOL/putnam_junior_high_updated.png'
		#self.metricMap = './data/INPUT/PARZIALI/battle_creekhs_1_updated14.png'	
		...
		self.nome_gt = './data/INPUT/XMLs/SCHOOL/putnam_junior_high_updated.xml'
		#self.nome_gt = './data/INPUT/XMLs/PARZIALI/battle_creekhs_1_updated14.xml'
...
class Parameter_obj():
	def __init__(self):
		...
		self.sogliaLateraleClusterMura =10 #TODO: ancora da aggiungere all'XML 
