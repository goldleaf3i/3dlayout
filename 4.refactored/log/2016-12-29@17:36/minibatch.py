...
# 			dsg.disegna_stanze(poligoni,colori , xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = '15_poligoni_esterni_stanza'+str(index), format='png')	
	...
	if par.mappa_completa:
		...
		indice_conf_bwd = lista_gt_proporzionata.index(max_bwd)
		indice_conf_fwd = lista_gt_proporzionata.index(max_fwd)
		temp = [lista_gt_proporzionata[indice_conf_bwd], lista_gt_proporzionata[indice_conf_fwd]]
		lista_gt_proporzionata = temp
