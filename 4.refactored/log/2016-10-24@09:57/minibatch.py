...
# 		dsg.disegna_segmenti(outliers, savename = "outliers")
	...
	dsg.disegna_stanze(out_poligoni, colori, xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename='prova')
	...
	for s in spazi_parziali:
		...
		for c in celle_confinanti:	
			st.append(c.cella)
		dsg.disegna_stanze(st, colori, xmin, ymin, xmax, ymax,savename='8b_celle_da_unire'+str(i))
		i+=1
