...
# 			dsg.disegna_stanze(poligoni,colori , xmin, ymin, xmax, ymax,filepath = path_obj.filepath, savename = '15_poligoni_esterni_stanza'+str(index), format='png')	
	...
	if par.DISEGNA:
		#disegno la mappa parziale segmentata con sovrapposta la mappa predetta
		dsg.disegna_sovrapposizione_predizione(copia_spazi, plan_o.spazi, contours , dsg.get_colors(plan_o.spazi), xmin, ymin, xmax, ymax, filepath = path_obj.filepath)
