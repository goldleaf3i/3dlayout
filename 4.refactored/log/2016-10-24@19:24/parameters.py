...
class Path_obj():
	def __init__(self):
		...
		self.metricMap = './data/INPUT/PARZIALI/battle_creekhs_1_updated160.png'
		...
		self.nome_gt = './data/INPUT/XMLs/PARZIALI/battle_creekhs_1_updated160.xml'
...
class Parameter_obj():
	def __init__(self):
		...
		self.sigma=0.00000125#0.1#0.00000125 #TODO: da inserire in XML. prima era 0.1
