...
(stanze, clustersCelle, estremi, colori) = lay.get_layout(metricMap, minVal, maxVal, rho, theta, thresholdHough, minLineLenght, maxLineGap, eps, minPts, h, minOffset, minLateralSeparation)

import accuracy
#funzione per eliminare stanze che sono dei buchi interni
stanze = accuracy.elimina_stanze(stanze,estremi)
#funzione per calcolare accuracy fc e bc
accuracy.calcola_accuracy(nome_gt,estremi,stanze,metricMap)
