...
def get_stanze_gt(nome_gt, estremi):
	'''
Prende in input il nome dell'xml ground e restituisce la lista di stanze ground truth, i loro nomi (classroom ecc), le loro label RC RCE e FCES e le coppie di stanze collegate
	'''
...
def get_corrispondenze(stanze, stanze_gt):
	'''
Riceve stanze segmentate e ground truth e ritorna corrispondenze backward e forward. La lista bwd è ordinata come stanze_gt, nella posizione i contiene l'indice della stanza segmentata che corrisponde alla i-esima stanza gt. Fwd è ordinata come stanze, nella posizione i contiene l'indice della stanza gt che corrisponde alla i-esima stanza segmentata.
	''' 
