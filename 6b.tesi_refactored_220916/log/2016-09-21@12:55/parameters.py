...
def load_from_XML(parXML):
	...
	for parametro in root.findall('parametri'):
		...
		parameter_obj.theta = int(parametro.find('p5').text)
		parameter_obj.thresholdHough = int(parametro.find('p6').text)
		parameter_obj.maxLineGap = int(parametro.find('p7').text)
		parameter_obj.minPts = int(parametro.find('p8').text)
		parameter_obj.h = int(parametro.find('p9').text)
		parameter_obj.minOffset = int(parametro.find('p10').text)
		parameter_obj.diagonali = int(parametro.find('p11').text)
		parameter_obj.m = int(parametro.find('p12').text)
		parameter_obj.flip_dataset = int(parametro.find('p13').text)
